This file contains several scripts for the simulation study of the paper on hierarchical network autocorrelation models for binary-valued network and weighted-edge network. 
